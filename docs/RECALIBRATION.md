...
| `corporate_risk_enabled` | **True** | the risk-side master switch — LIVE by default | **flipped ON 2026-08-18** (#280; pre-verified 0 withheld / 0 verdict changes on real prod data — the moderate 8-K counter-case); the replay lab INHERITS this default (option A, 2026-08-20) — `--no-corporate-risk` forces it OFF for an off-leg measure |
